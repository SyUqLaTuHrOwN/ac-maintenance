...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\ac-maintenance\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\ac-maintenance\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'livewire.update','livewire.upload-file','livewire.preview-file','home','login','register','password.request',
'password.reset','verification.notice','verification.verify','password.confirm','logout','schedule.client.confirm','schedule.client.cancel','schedule.client.reschedule.form','schedule.client.reschedule.submit',
'redirect','admin.dashboard','admin.clients','admin.locations','admin.units',
'admin.schedules','admin.technicians','admin.reports','admin.users','admin.settings',
'admin.register','teknisi.dashboard','teknisi.tasks','teknisi.reports','teknisi.history',
'teknisi.profile','client.dashboard','client.units','client.schedules','client.reports',
'client.feedback','client.requests','client.complaints','storage.local',);
        registerArgumentsSet('views', 
'client.schedule-reschedule-form','client.schedule-response','components.action-message','components.application-logo','components.auth-session-status',
'components.danger-button','components.dropdown','components.dropdown-link','components.input-error','components.input-label',
'components.modal','components.nav-link','components.nav.link','components.nav.section','components.primary-button',
'components.responsive-nav-link','components.secondary-button','components.text-input','dashboard','layouts.app',
'layouts.guest','livewire.admin.clients.index','livewire.admin.dashboard','livewire.admin.locations.index','livewire.admin.register.index',
'livewire.admin.reports.index','livewire.admin.schedules.index','livewire.admin.settings.index','livewire.admin.technicians.index','livewire.admin.units.index',
'livewire.admin.users.index','livewire.auth.login','livewire.client.complaints.index','livewire.client.dashboard','livewire.client.feedback.index',
'livewire.client.reports.index','livewire.client.requests.index','livewire.client.schedules.index','livewire.client.units.index','livewire.landing.home-page',
...
'livewire.pages.auth.reset-password','livewire.pages.auth.verify-email','livewire.profile.delete-user-form','livewire.profile.update-password-form','livewire.profile.update-profile-information-form',
'livewire.teknisi.dashboard','livewire.teknisi.history.index','livewire.teknisi.profile.index','livewire.teknisi.reports.index','livewire.teknisi.tasks.index',
'livewire.welcome.navigation','profile','volt-livewire::admin.clients.index','volt-livewire::admin.dashboard','volt-livewire::admin.locations.index',
'volt-livewire::admin.register.index','volt-livewire::admin.reports.index','volt-livewire::admin.schedules.index','volt-livewire::admin.settings.index','volt-livewire::admin.technicians.index',
'volt-livewire::admin.units.index','volt-livewire::admin.users.index','volt-livewire::auth.login','volt-livewire::client.complaints.index','volt-livewire::client.dashboard',
'volt-livewire::client.feedback.index','volt-livewire::client.reports.index','volt-livewire::client.requests.index','volt-livewire::client.schedules.index','volt-livewire::client.units.index',
'volt-livewire::landing.home-page','volt-livewire::layout.navigation','volt-livewire::pages.auth.confirm-password','volt-livewire::pages.auth.forgot-password','volt-livewire::pages.auth.login',
...
'volt-livewire::profile.update-profile-information-form','volt-livewire::teknisi.dashboard','volt-livewire::teknisi.history.index','volt-livewire::teknisi.profile.index','volt-livewire::teknisi.reports.index',
'volt-livewire::teknisi.tasks.index','volt-livewire::welcome.navigation','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.ac-maintenance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
